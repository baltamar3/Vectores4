...
public class Interfaz extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtElementoRepetido = new javax.swing.JTextField();
        ...
        jLabel1.setText("ELEMENTO QUE MAS SE REPITE EN UN VECTOR");
        ...
        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 50, 150, 240));

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Resultados"));
        jPanel3.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel3.setText("Elemento De Mayor Frecuencia");
        jPanel3.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 50, -1, -1));

        txtElementoRepetido.setEditable(false);
        jPanel3.add(txtElementoRepetido, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 70, 60, -1));

        jLabel4.setText("Frecuencia Del Elemento");
        jPanel3.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 110, -1, -1));

        txtFrecuencia.setEditable(false);
        jPanel3.add(txtFrecuencia, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 130, 60, -1));

        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, 210, 170));
    ...
    private void cmdLlenaManualrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdLlenaManualrActionPerformed
        ...
        for (int i = 0; i < v.length; i++) {
            n=Integer.parseInt(JOptionPane.showInputDialog(this, "digite el elemento numero "+(i+1)));
            v[i]=n;
        }
    ...
    private void cmdCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdCalcularActionPerformed
        ...
        for (int i = 0; i < v.length; i++) {
           frecuenciaTemp = 0;
            for(int j =0 ; j< v.length; j++){
                if(v[i] == v[j])
                    frecuenciaTemp=frecuenciaTemp+1;                
            }
        ...
        String elemento=String.valueOf(moda);
        txtElementoRepetido.setText(elemento);
        String frecuencia=String.valueOf(frecuenciaModa);
    ...
    private javax.swing.JTextField txtElementoRepetido;
